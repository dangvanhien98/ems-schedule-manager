...
import { GroupWeekState } from '../models/group-week.i';
...
export class StoreFacade {
  ...
  getScheduleGroupWeek(){
    return this.store.select(getScheduleUserGroup);
  }

  getValueInitGroupWeek(){
    this.store.select(getScheduleUserGroup).subscribe(data => {
      this.groupWeek = {...data}
    })
  }
}
