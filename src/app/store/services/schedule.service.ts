...
export class ScheduleService {
  ...
  loadScheduleGroupUser(pagination: Pagination, scheduleGroupUserParam: ScheduleGroupUserParam): Observable<Page<ListScheduleContent>>{
    const params = new HttpParams({
      fromObject: {
        page: String(pagination.page),
        pageSize: String(pagination.pageSize),
        director: String(scheduleGroupUserParam.director),
        startDate: format(scheduleGroupUserParam.startDate, "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'"),
        endDate: format(scheduleGroupUserParam.endDate, "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'")
      },
    });

    return this.http.get<Page<ListScheduleContent>>(`${environment.urlSchedule}/group`, {params});
  }
}
