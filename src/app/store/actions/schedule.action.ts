...
import { ScheduleGroupUserParam } from '../models/schedule-group-user.i';
import { ListScheduleContent } from '../models/list-schedule-content';
export enum ESchedule {
  ...
  LOAD_GROUP_USER = '[Schedule] load group user',
  LOAD_GROUP_USER_SUCCESS = '[Schedule] load group user success',
  LOAD_GROUP_USER_FAIL = '[Schedule] load group user fail'
}
...
// group user schedule -------------------------------------------
export class ScheduleGroupUser implements Action {
  public readonly type = ESchedule.LOAD_GROUP_USER;
  constructor(public payload: { paginationGroupWeek: Pagination; paramsGroupWeek: ScheduleGroupUserParam }) {}
}

export class ScheduleGroupUserSuccess implements Action {
  public readonly type = ESchedule.LOAD_GROUP_USER_SUCCESS;
  constructor(public payload: { schedulesGroupWeek: ListScheduleContent[]; paginationGroupWeek: Pagination ;paramsGroupWeek: ScheduleGroupUserParam}) {}
}

export class ScheduleGroupUserFail implements Action {
  public readonly type = ESchedule.LOAD_GROUP_USER_FAIL;
  constructor(public payload: { message: string }) {}
}
...
export type ScheduleAction =
  ...
  | ScheduleFilterFail
  | ScheduleGroupUser
  | ScheduleGroupUserSuccess
  | ScheduleGroupUserFail;
