...
describe('ScheduleDetailComponent', () => {
  ...
  describe("scheduleEdit", () => {
    it("editClickEmt should emit", () => {
      const spy = spyOn(component.editClickEmt, 'emit');
  ...
  describe("scheduleDelete", () => {
    it("deleteClickEmt should emit", () => {
      const spy = spyOn(component.deleteClickEmt, 'emit');
  ...
  describe("scheduleCancel", () => {
    it("cancelClickEmt should emit", () => {
      const spy = spyOn(component.cancelClickEmt, 'emit');
